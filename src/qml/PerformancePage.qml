            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    GridLayout {
                        ...
                        Repeater {
                            model: SysMonitor.cpu.coreCount
                            ...
                            ColumnLayout {
                                ...
                                readonly property real coreUsage: {
                                    let usageList = SysMonitor.cpu.perCoreUsage;
                                    return (usageList && usageList.length > index) ? usageList[index] : 0;
                                }
                                ...
                                Rectangle {
                                    ...
                                    Rectangle {
                                        ...
                                        width: parent.width * coreDelegate.coreUsage
                                        radius: 3
